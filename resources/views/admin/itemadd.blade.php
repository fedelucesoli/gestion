                  ...
                  <div class="panel-body">
                    <form class="form-horizontal" action="{{ route("admin.item.add") }}" method="post" id="my-awesome-dropzone"  enctype="multipart/form-data">
                     ...
                     <div class="form-group ">
                      <label class="control-label col-sm-4 requiredField" for="titulo">Titulo
                     ...
                     {{-- <div class="form-group ">
                      ...
                      <label class="control-label col-sm-4 requiredField" for="titulo">Subir imagenes<span class="asteriskField">*</span>
                      </label>
                     ...
                     <div class="form-group ">
                      <label class="control-label col-sm-4 requiredField" for="categoria">
                       Categoria
                       <span class="asteriskField">
                        *
                       </span>
                     ...
                     <div class="form-group ">
                      <label class="control-label col-sm-4 requiredField" for="descripcion">
                       Descripci&oacute;n
                       <span class="asteriskField">
                        *
                       </span>
                     ...
                     <div class="form-group ">
                      <label class="control-label col-sm-4" for="fecha_inicio">
                       Fecha de inicio
                      </label>
                      <div class="col-sm-8">
                     ...
                     <div class="form-group ">
                      <label class="control-label col-sm-4" for="fecha_fin">
